...
```powershell
certutil -hashfile CuadernoPro-8.4.8-Setup.exe SHA256
```
...
2. Comprueba que el archivo se llama `CuadernoPro-8.4.8-Setup.exe`.
...
1. Ejecuta `CuadernoPro-8.4.8-Setup.exe`.
