...
- Instalador Windows recomendado: `https://github.com/jomarpel-star/cuadernopro/releases/download/v8.4.6/CuadernoPro-8.4.6-Setup.exe`.
- SHA256: `https://github.com/jomarpel-star/cuadernopro/releases/download/v8.4.6/SHA256SUMS.txt`.
