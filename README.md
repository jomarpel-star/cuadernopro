...
CuadernoPro v8.4.10 permite personalizar en Mapas los colores de los cultivos,
manteniendo fijos almendro, olivar y tierras arables. Las preferencias se
guardan automáticamente en la base local. No requiere migración manual y
conserva los datos existentes.

## Instalación rápida

1. Descargar `CuadernoPro-8.4.10-Setup.exe` desde la release publicada.
...
- [ATRIBUCIONES_DATOS.md](ATRIBUCIONES_DATOS.md)
